...
## Estado a 22-09-2026: 30 das 30 feitas

Todas as ideias têm agora uma versão real na app (com testes onde há lógica):

**1** cartões com lacunas · **2** confiança de 1 a 5 · **3** agendamento que aprende (facilidade própria por cartão, 0.5x-2.5x, ajustada pela confiança de cada revisão) · **4** jogo de pares · **5** cartões em áudio · **6** baralho até à frequência (link direto do Modo Frequência para os flashcards da cadeira, `/flashcards?cadeira=X&baralho=1`) · **7** Modo Exame (90 minutos, cronómetro, escolhe um caso do arquivo) · **8** Tópicos de Correção (marca tinha/faltou, diz o que reclamar — com o prazo real do art. 29.º — e o que rever) · **9** fichas de jurisprudência · **10** ligações entre notas (artigos, casos e anotações mostram onde mais aparecem) · **11** diário de erros · **12** mapas mentais (caixas e setas em SVG, por cadeira) · **13** calculadora de prazos · **14** prazos em cadeia · **15** plano de estudo da semana (uma cadeira por dia, a partir das próximas provas — aceita, muda ou ignora) · **16** folha de horas de estudo (no Perfil) · **17** mapa de calor · **18** horas por registar (adaptado: pergunta ao fim do dia se não houver sessão) · **19** foco atado a uma tarefa (cronómetro liga-se a uma tarefa pendente, oferece continuar se saíres a meio) · **20** Modo Frequência · **21** sequência com descanso semanal · **22** missões do dia (25 min, 10 cartões, 1 sumário) · **23** sequência a dois (opcional, a consola mostra só "estudou hoje: sim/não") · **24** toga que se completa (capelo, beca, fita, medalha) · **25** balanço de domingo · **26** portfólio · **27** diário de estágio · **28** família Profissional no calendário · **29** checklists · **30** contactos, com lembrete de "voltar a falar".

Além disso: as **perguntas para o stor**, a página **Respirar** e o **registo diário de bem-estar** (spec 25, desligado por defeito).

As 13 ideias que faltavam (3, 6, 7, 8, 10, 12, 15, 18, 19, 22, 23, 24, 25) foram todas implementadas na sessão de 22-09-2026, em lotes testados e commitados separadamente (7 e 8 primeiro; as outras 11 a seguir, a pedido). As duas marcadas como "G" (mapas mentais, plano de estudo) ficaram como MVPs reais e funcionais, não a "fase inteira" que o documento original imaginava — dá para crescer a partir daqui quando fizer sentido.
