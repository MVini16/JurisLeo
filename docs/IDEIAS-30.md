...
## Estado a 22-09-2026: 19 das 30 feitas

Feitas (com testes onde há lógica): **1** cartões com lacunas · **2** confiança de 1 a 5 · **4** jogo de pares · **5** cartões em áudio · **7** Modo Exame (90 minutos, cronómetro, escolhe um caso do arquivo) · **8** Tópicos de Correção (marca tinha/faltou, diz o que reclamar — com o prazo real do art. 29.º — e o que rever) · **9** fichas de jurisprudência · **11** diário de erros · **13** calculadora de prazos · **14** prazos em cadeia · **16** folha de horas de estudo (no Perfil) · **17** mapa de calor · **20** Modo Frequência · **21** sequência com descanso semanal · **26** portfólio · **27** diário de estágio · **28** família Profissional no calendário · **29** checklists · **30** contactos, com lembrete de "voltar a falar". Além disso: as **perguntas para o stor**, a página **Respirar** e o **registo diário de bem-estar** (spec 25, desligado por defeito).

Por fazer (11): **3** agendamento que aprende (os intervalos já foram decididos — 1,3,7,16,35 — falta o agendamento por dificuldade própria do cartão) · **6** baralho até à frequência · **10** ligações entre notas · **12** mapas mentais · **15** plano de estudo · **18** horas por registar · **19** foco atado a uma tarefa · **22** missões do dia · **23** sequência a dois · **24** toga · **25** balanço de domingo.
